...
RUN git clone https://github.com/xolentum/xolentum --depth=1 --branch=master .
...
COPY --from=og /opt/xolentum/build/release/bin/xolentumd /bin/xolentumd
COPY --from=og /opt/xolentum/build/release/bin/xolentum-wallet-cli /bin/xolentum-wallet-cli
COPY --from=og /opt/xolentum/build/release/bin/xolentum-wallet-rpc /bin/xolentum-wallet-rpc
